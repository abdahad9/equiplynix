...
const AllLessees = () => {
  ...
  const defaultTable =
    [
      { id: "10", ref: "test", contact_name: "test", contact_phone: "test", contact_email: "test", partner: "test", rep: "test"},
        ...
        <Container fluid>
            <Row>
                <Col lg={12}>
                    <Card>
                        <CardHeader>
                            <h5 className="card-title mb-0">All Lessee's</h5>
                        </CardHeader>
                            <CardBody>
                                <TableContainer
                                    columns={(columns || [])}
                                    ...
                                    createButtonText="Create New Lessee"
                                    isAddUserList={true}
